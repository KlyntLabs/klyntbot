...
| Component | Key Files |
|-----------|-----------|
| Memory types | `crates/cognitive/src/types.rs` |
| FSRS decay | `crates/cognitive/src/decay.rs` |
| Salience filter | `crates/cognitive/src/salience.rs` |
| Fact extraction | `crates/cognitive/src/extraction.rs` |
| Consolidation | `crates/cognitive/src/consolidation.rs` |
| Background pipeline | `crates/cognitive/src/background.rs` |
| Memory retrieval | `crates/cognitive/src/retrieval.rs` |
| Conversation recall | `crates/cognitive/src/conversation_recall.rs` |
| Context injection | `crates/cognitive/src/context_source.rs` |
| Weekly reflection | `crates/cognitive/src/reflection.rs` |
| Compaction | `crates/cognitive/src/compaction.rs` |
| User situation | `crates/cognitive/src/situation.rs` |
| Vector store | `crates/storage/src/vector_store.rs` |
| Context engine | `crates/context_engine/src/assembler.rs` |
| Budget allocator | `crates/context_engine/src/budget.rs` |
| History compressor | `crates/context_engine/src/history_compressor.rs` |
| Domain events | `crates/bus/src/domain_events.rs` |
| Agent runtime (10-step pipeline) | `crates/agent/src/agent_runtime/runtime.rs` |
| Agent loop (message pump) | `crates/agent/src/agent_loop/mod.rs` |
| Agent loop builder (wiring) | `crates/agent/src/agent_loop/builder.rs` |
| Intent analysis (heuristic + LLM) | `crates/agent/src/intent_pipeline/analysis.rs` |
| ReAct engine | `crates/agent/src/intent_pipeline/engines/reactive.rs` |
| Execution core (LLM + tools) | `crates/agent/src/execution/core.rs` |
| Execution router | `crates/agent/src/intent_pipeline/router.rs` |
| Provider manager (circuit breaker) | `crates/providers/src/manager.rs` |
| Provider registry (11 providers) | `crates/providers/src/registry.rs` |
| Anthropic native API | `crates/providers/src/anthropic_native.rs` |
| OpenAI-compat API | `crates/providers/src/openai_compat.rs` |
| Cognitive handlers (LLM + heuristic) | `crates/agent/src/cognitive_handlers.rs` |
| Cognitive embedder impl | `crates/agent/src/cognitive_embedder.rs` |
| Session manager | `crates/session/src/manager.rs` |
| Cost tracker | `crates/agent/src/output/cost_tracker.rs` |
| Response validator | `crates/agent/src/output/validator.rs` |
| Tool framework (traits) | `crates/tools-core/src/lib.rs` |
| Tool registry (deadlock-safe) | `crates/tools-core/src/registry.rs` |
| Feature package trait | `crates/tools-core/src/feature.rs` |
| Tool derive macro | `crates/tools-core-macros/src/tool_derive.rs` |
| ToolParams derive macro | `crates/tools-core-macros/src/tool_params.rs` |
| Multi-action dispatch | `crates/tools-core-macros/src/tool_actions.rs` |
| Browser tool (trust levels) | `crates/tools/src/browser.rs` |
| Ask user tool (3 paths) | `crates/tools/src/ask_user.rs` |
| Memory tool (RRF search) | `crates/tools/src/memory_tool.rs` |
| Delegation tool | `crates/tools/src/delegation.rs` |
| MCP client manager | `crates/mcp/src/client/manager.rs` |
| MCP tool adapter | `crates/mcp/src/client/tool_adapter.rs` |
| MCP name sanitization | `crates/mcp/src/client/sanitize.rs` |
| Plugin manager | `crates/plugin-runtime/src/manager.rs` |
| WASM plugin tool | `crates/plugin-runtime/src/wasm_plugin.rs` |
| Channel trait + reconnect | `crates/channels/src/lib.rs` |
| Telegram (raw HTTP) | `crates/channels/src/telegram.rs` |
| Discord (raw WebSocket) | `crates/channels/src/discord.rs` |
| AppCore state | `crates/app-core/src/state.rs` |
| AppCore initialization | `crates/app-core/src/init.rs` |
| Desktop event wiring | `crates/desktop/src/app_core.rs` |
| Desktop main + windows | `crates/desktop/src/main.rs` |
