...
| EUPI | Entity-update intent projection | ../2026-09-02-entity-update-intent/ | Implemented | — | entity-update intent, entity:updated, ToolEnd, MCP bridge emit, session_tool_domain, per-tool read-only | `crates/app-core/`, `crates/klyntbot-server/` |
