...
describe("isKnownLocalWorkspaceRoutePath", () => {
  ...
  it("still allows file-like descendants under reserved workspace names", () => {
    ...
    expect(isKnownLocalWorkspaceRoutePath("/workspaces/team/settings/src/App.tsx")).toBe(false);
    expect(isKnownLocalWorkspaceRoutePath("/workspaces/team/reviews/src/App.tsx")).toBe(false);
  });
  ...
  it("treats extensionless descendants under reserved workspace names as mounted files", () => {
    ...
    expect(isKnownLocalWorkspaceRoutePath("/workspaces/team/settings/Makefile")).toBe(false);
    expect(isKnownLocalWorkspaceRoutePath("/workspaces/team/reviews/bin/tool")).toBe(false);
  });
});
