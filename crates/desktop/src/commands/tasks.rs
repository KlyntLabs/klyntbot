...
#[klynt_command]
pub async fn task_create(app: tauri::AppHandle, params: TaskCreateParams) -> TaskResponse {
...
#[klynt_command]
pub async fn task_update(app: tauri::AppHandle, params: TaskUpdateParams) -> TaskResponse {
...
#[klynt_command]
pub async fn task_delete(app: tauri::AppHandle, id: String) -> bool {
...
#[klynt_command]
pub async fn task_toggle_complete(app: tauri::AppHandle, id: String) -> TaskResponse {
