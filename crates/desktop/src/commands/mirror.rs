...
#[klynt_command]
pub async fn approve_meta_rule(app: tauri::AppHandle, rule_id: Uuid) -> () {
...
#[klynt_command]
pub async fn dismiss_meta_rule(app: tauri::AppHandle, rule_id: Uuid) -> () {
...
#[klynt_command]
pub async fn revert_brain_version(app: tauri::AppHandle, version: u32) -> BrainVersion {
...
#[klynt_command]
pub async fn kill_trial(app: tauri::AppHandle, trial_id: String) -> () {
...
#[klynt_command]
pub async fn continue_trial(app: tauri::AppHandle, trial_id: String) -> () {
