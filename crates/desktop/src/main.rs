...
fn run_desktop_app() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::coding_memory::coding_memory_recall_index,
            commands::coding_memory::coding_memory_recall_timeline,
            commands::coding_memory::coding_memory_recall_fetch,
            commands::coding_memory::coding_memory_check_dead_ends,
            commands::coding_memory::coding_memory_recall_facts_as_of,
            commands::coding_memory::coding_memory_recall_change_history,
