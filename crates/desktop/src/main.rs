...
fn run_desktop_app() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::database::db_delete_database,
            ...
            commands::database::db_list_views,
            commands::database::db_create_view,
            commands::database::db_update_view,
            commands::database::db_delete_view,
            commands::database::db_get_suggestions,
            commands::database::db_resolve_suggestion,
