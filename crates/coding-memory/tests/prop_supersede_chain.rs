...
async fn supersede_chain_equality() {
    ...
    let old = SemanticFact {
        id: "old".into(), domain: "work".into(),
        subject: "repo:x".into(), predicate: "fw".into(), object: "v1".into(),
        confidence: 0.9, source: "distiller".into(),
        valid_from: "2026-01-01T00:00:00".into(), valid_until: None,
    ...
    let new = SemanticFact {
        id: "new".into(), domain: "work".into(),
        subject: "repo:x".into(), predicate: "fw".into(), object: "v2".into(),
        confidence: 0.95, source: "distiller".into(),
        valid_from: "2026-02-01T00:00:00".into(), valid_until: None,
        recorded_at: Timestamp::now().to_string(),
        superseded_at: None, superseded_by: None,
        stability: 1.0, last_accessed: None, access_count: 0,
        convergence_score: 1.0, project_id: None,
    ...
    writer.complete_supersede("old", "new", "2026-02-01T00:00:00").await.unwrap();
