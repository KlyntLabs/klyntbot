...
pub struct FinanceBudgetRow {
    ...
    pub start_date: SqlDate,
    pub end_date: Option<SqlDate>,
    pub is_active: bool,
...
pub struct FinanceInvestmentRow {
    ...
    pub purchase_date: Option<SqlDate>,
...
pub struct FinanceGoalPatch {
    ...
    pub deadline: Option<Option<SqlDate>>,
...
pub struct FinanceTransactionFilter {
    ...
    pub category: Option<String>,
    pub date_from: Option<SqlDate>,
    pub date_to: Option<SqlDate>,
