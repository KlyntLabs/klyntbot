...
pub struct CoachingInitResult {
    pub intervention_rx: std::sync::Mutex<
        Option<tokio::sync::mpsc::Receiver<feature_coaching::router::DeliveredIntervention>>,
    >,
...
mod init {
    ...
    use feature_coaching::{
        FeedbackTracker, InterventionRouter, PatternDetector, SignalAccumulator,
    };
