...
pub const FOCUS_ON_BYTES: &[u8] = include_bytes!("../../assets/Klyntbot Focus On.shortcut");

/// Bundled "Klyntbot Focus Off" shortcut binary.
pub const FOCUS_OFF_BYTES: &[u8] = include_bytes!("../../assets/Klyntbot Focus Off.shortcut");
