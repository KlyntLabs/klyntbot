...
static ANTHROPIC_MODELS: LazyLock<Vec<ProviderModel>> = LazyLock::new(anthropic_models);
static OPENAI_MODELS: LazyLock<Vec<ProviderModel>> = LazyLock::new(openai_models);
static MOONSHOT_MODELS: LazyLock<Vec<ProviderModel>> = LazyLock::new(moonshot_models);
static DEEPSEEK_MODELS: LazyLock<Vec<ProviderModel>> = LazyLock::new(deepseek_models);
static ZHIPU_MODELS: LazyLock<Vec<ProviderModel>> = LazyLock::new(zhipu_models);
static GROQ_MODELS: LazyLock<Vec<ProviderModel>> = LazyLock::new(groq_models);
static XAI_MODELS: LazyLock<Vec<ProviderModel>> = LazyLock::new(xai_models);
static GEMINI_MODELS: LazyLock<Vec<ProviderModel>> = LazyLock::new(gemini_models);
