...
impl ApiError {
    ...
    pub fn unprocessable(msg: impl Into<String>) -> Self {
        Self { status: 422, message: msg.into() }
    }
...
impl From<common::KlyntbotError> for ApiError {
    fn from(e: common::KlyntbotError) -> Self {
        match &e {
            ...
            common::KlyntbotError::StorageConflict(msg) => {
                Self { status: 409, message: msg.clone() }
            }
            // Storage errors don't leak internal details
            common::KlyntbotError::Storage(_) => Self::internal("Storage error"),
            common::KlyntbotError::Config(_) => {
                Self { status: 422, message: e.to_string() }
            }
