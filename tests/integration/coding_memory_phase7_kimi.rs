//! Phase 7 integration test: Kimi adapter ingests synthetic session.

use coding_ingest::adapters::kimi_cli::KimiAdapter;
use coding_ingest::adapters::IngestAdapter;

#[test]
fn kimi_session_parses_all_events() {
    let adapter = KimiAdapter;
    let fixture = include_str!("../fixtures/coding/synthetic_session_kimi.jsonl");
    let mut count = 0;
