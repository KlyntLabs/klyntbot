...
async fn test_context_builder_init() {
    ...
    let mut context_builder = ContextBuilder::new(workspace, None);
...
async fn test_multiple_context_builders() {
    ...
    let mut builder1 = ContextBuilder::new(workspace.clone(), None);
    let mut builder2 = ContextBuilder::new(workspace.clone(), None);
