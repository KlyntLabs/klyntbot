        ...
        return (
          ...
          >
            ...
            {matched?.qualityScore != null && height > 24 && (
              <span className="absolute top-0.5 right-0.5 text-[7px] font-bold text-primary bg-overlay rounded-full px-1 leading-tight">
            ...
            {height > 18 && (
              <span className="text-[9px] text-primary font-medium px-1 truncate block leading-tight mt-0.5">
                {session.label}
              </span>
            )}
