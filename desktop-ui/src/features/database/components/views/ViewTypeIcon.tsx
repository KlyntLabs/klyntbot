...
const ICON_PATHS: Record<ViewType, string> = {
  table:
    "M3 6h18M3 12h18M3 18h18M9 4v16M15 4v16",
...
export const VIEW_TYPES: ViewType[] = ["table", "board", "calendar", "list", "gallery", "timeline"];
