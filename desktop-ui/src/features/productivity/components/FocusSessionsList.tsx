...
export function FocusSessionsList({ date }: FocusSessionsListProps) {
  ...
  if (sessions.length === 0) {
    return (
      <div className="glass-card p-4">
        <h2 className="text-[13px] font-medium text-muted-foreground mb-3">Focus Sessions</h2>
  ...
  return (
    <div className="glass-card p-4 flex flex-col gap-3">
      <h2 className="text-[13px] font-medium text-muted-foreground">Focus Sessions</h2>
      <div className="flex flex-col gap-0.5">
        {sessions.map((s) => {
          ...
          return (
            ...
            >
              <span className="text-[11px] font-light text-muted-foreground tabular-nums w-14">
