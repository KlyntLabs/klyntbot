...
const STORAGE_KEY_THREAD_ACTIVITY = "klynt.threadLastUserActivity";
export const STORAGE_KEY_PINNED_THREADS = "klynt.pinnedThreads";
export const STORAGE_KEY_CUSTOM_NAMES = "klynt.threadCustomNames";
export const STORAGE_KEY_THREAD_CODEX_PARAMS = "klynt.threadCodexParams";
export const STORAGE_KEY_DETACHED_REVIEW_LINKS = "klynt.detachedReviewLinks";
