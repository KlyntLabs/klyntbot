...
describe("Markdown file-like href behavior", () => {
  ...
  it("still intercepts dotless workspace file hrefs when a file opener is provided", () => {
    ...
    render(
      <Markdown
        value="See [license](/workspace/Klynt/LICENSE)"
        className="markdown"
        workspacePath="/Users/sotiriskaniras/Documents/Development/Forks/Klynt"
        onOpenFileLink={onOpenFileLink}
      />,
    );

    const link = screen.getByText("license").closest("a");
    expect(link?.getAttribute("href")).toBe("/workspace/Klynt/LICENSE");
    ...
    fireEvent(link as Element, clickEvent);
    expect(clickEvent.defaultPrevented).toBe(true);
    expectOpenedFileTarget(onOpenFileLink, "/workspace/Klynt/LICENSE");
  });
  ...
  it("still intercepts nested workspace file hrefs when a file opener is provided", () => {
    ...
    render(
      <Markdown
        value="See [src](/workspaces/team/Klynt/src)"
        className="markdown"
        workspacePath="/Users/sotiriskaniras/Documents/Development/Forks/Klynt"
        onOpenFileLink={onOpenFileLink}
      />,
    ...
    expect(link?.getAttribute("href")).toBe("/workspaces/team/Klynt/src");
    ...
    fireEvent(link as Element, clickEvent);
    expect(clickEvent.defaultPrevented).toBe(true);
    expectOpenedFileTarget(onOpenFileLink, "/workspaces/team/Klynt/src");
  });
  ...
  it("intercepts Windows absolute file hrefs with #L anchors and preserves the tooltip", () => {
    ...
    const linkedPath =
      "I:\\gpt-projects\\Klynt\\src\\features\\settings\\components\\sections\\SettingsDisplaySection.tsx#L422";
    render(
      <Markdown
    ...
    expect(link?.getAttribute("href")).toBe(
      "I:%5Cgpt-projects%5CKlynt%5Csrc%5Cfeatures%5Csettings%5Ccomponents%5Csections%5CSettingsDisplaySection.tsx#L422",
    );
    expect(link?.getAttribute("title")).toBe(
      "I:\\gpt-projects\\Klynt\\src\\features\\settings\\components\\sections\\SettingsDisplaySection.tsx:422",
    );
    ...
    expectOpenedFileTarget(
      onOpenFileLink,
      "I:\\gpt-projects\\Klynt\\src\\features\\settings\\components\\sections\\SettingsDisplaySection.tsx",
      422,
    );
