  ...
  return (
    <IssueContextMenu issue={issue}>
      <motion.div
        ...
        className={`bg-bg rounded-md shadow-xs border border-separator/50 p-3 cursor-pointer space-y-2 ${isDragging ? "opacity-50 cursor-grabbing" : ""}`}
      >
        <div className="flex items-center gap-2">
          <issue.priority.icon className="size-4 text-fg-secondary" />
          <span className="text-ui-sm text-fg-secondary font-medium">{issue.identifier}</span>
        </div>
