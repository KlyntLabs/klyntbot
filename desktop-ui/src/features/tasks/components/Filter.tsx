              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-1">
                    {count > 0 && (
                      <span className="flex items-center justify-center size-5 rounded-full bg-brand text-background text-ui-sm">
                        {count}
                      </span>
                    )}
            ...
            <>
              ...
              <CommandGroup>
                <CommandItem
                  ...
                  className="justify-center text-status-danger"
                >
            ...
            {statuses.map((s) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="text-ui-sm text-fg-secondary">{count}</span>
                </CommandItem>
              );
            })}
          </CommandGroup>
    ...
    >
      <PopoverTrigger asChild>
        <Button size="xs" variant="ghost">
          ...
          Filter
          {activeCount > 0 && (
            <span className="ml-1 flex items-center justify-center size-5 rounded-full bg-brand text-background text-ui-sm">
              {activeCount}
            </span>
          )}
        </Button>
        ...
        {activeCategory ? (
          <div>
            <button
              ...
              className="flex items-center gap-1 px-3 py-2 text-sm text-fg-secondary hover:text-fg transition-colors w-full border-b border-separator"
            >
