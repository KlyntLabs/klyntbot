...
describe("useResizablePanels", () => {
  ...
  it("reads stored sizes and clamps to bounds", () => {
    window.localStorage.setItem("klynt.sidebarWidth", "999");
    window.localStorage.setItem("klynt.rightPanelWidth", "100");
    window.localStorage.setItem("klynt.planPanelHeight", "not-a-number");
