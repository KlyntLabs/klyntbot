  ...
  return (
    <div ref={ref} className="relative ml-2">
      <button
        ...
        className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-[11px] font-light transition-all duration-200 border border-white/[0.08] hover:bg-white/[0.06]"
      >
        {mode === "multi" ? (
      ...
      {open && (
        <div className="absolute right-0 top-full mt-1 z-50 min-w-[120px] py-1 rounded-lg glass-panel border border-white/[0.08] shadow-xl">
          <DropItem
            label="Multi"
  ...
  return (
    <button
      ...
      className={`w-full flex items-center gap-2 px-3 py-1.5 text-[11px] transition-colors ${
        active ? "text-brand" : "text-secondary hover:text-primary hover:bg-white/[0.04]"
      }`}
    >
