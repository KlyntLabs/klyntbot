...
type UseMainAppLayoutSurfacesArgs = {
  ...
  onSelectProvider: ComposerProps["onSelectProvider"];
  ...
  return {
    ...
    gitDiffPanelProps: {
      ...
      worktreeApplyLoading: worktreeState.isWorktreeWorkspace
        ...
        : false,
      worktreeApplyError: worktreeState.isWorktreeWorkspace ? gitState.worktreeApplyError : null,
    ...
    gitDiffViewerProps: {
      ...
      pullRequestComments: gitState.diffSource === "pr" ? gitState.gitPullRequestComments : [],
