...
export const commands = {
  ...
  async chatZombieCheck(thresholdMs: number): Promise<Result<SessionRow[], ApiError>> {
    try {
      return { status: "ok", data: await TAURI_INVOKE("chat_zombie_check", { thresholdMs }) };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
    }
  },
  async chatForceReset(sessionKey: string): Promise<Result<null, ApiError>> {
    try {
      return { status: "ok", data: await TAURI_INVOKE("chat_force_reset", { sessionKey }) };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
    }
  ...
  async getGitCommitDiff(
    workspaceId: string,
    sha: string,
  ): Promise<Result<GitCommitDiff[], ApiError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_git_commit_diff", { workspaceId, sha }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async checkoutGitBranch(workspaceId: string, name: string): Promise<Result<null, ApiError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("checkout_git_branch", { workspaceId, name }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async initGitRepo(
    ...
    branch: string,
    force: boolean,
  ): Promise<Result<InitGitRepoResponse, ApiError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("init_git_repo", { workspaceId, branch, force }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async generateCommitMessage(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("generate_commit_message", { workspaceId, commitMessageModelId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async createGithubRepo(
    ...
    visibility: string,
    branch: string | null,
  ): Promise<Result<CreateGitHubRepoResponse, ApiError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("create_github_repo", { workspaceId, repo, visibility, branch }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async focusDefaultsSet(
    update: FocusDefaultsUpdate,
  ): Promise<Result<FocusDefaultsResponse, ApiError>> {
    try {
  ...
  async subagentListActive(threadId: string): Promise<Result<null, ApiError>> {
    try {
  ...
  async subagentInspect(agentId: string): Promise<Result<null, ApiError>> {
    try {
  ...
  async subagentListForSession(sessionId: string): Promise<Result<null, ApiError>> {
    try {
  ...
  async tracingLoadSubagentContext(
    providerId: string,
    sessionId: string,
    agentId: string,
  ): Promise<Result<ContextMessage[], ApiError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("tracing_load_subagent_context", {
          providerId,
          sessionId,
          agentId,
        }),
  ...
  async tracingLoadSubagentSession(
    providerId: string,
    sessionId: string,
    agentId: string,
  ): Promise<Result<SessionDetail, ApiError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("tracing_load_subagent_session", {
          providerId,
          sessionId,
          agentId,
        }),
  ...
  async tracingImport(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("tracing_import", { providerId, bytes, fileName }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async tracingSessionSummary(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("tracing_session_summary", { providerId, sessionId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
...
export type EmbeddedMcpRejection = {
  name: string;
  /**
   * `unknown` | `forbidden`
   */
...
export type FocusDefaultsResponse = {
  workMins: number;
...
export type FocusDefaultsUpdate = {
  workMins: number | null;
...
export type InitGitRepoResponse =
  | { status: "initialized"; commitError?: string | null }
...
export type SessionMetadataInfo = {
  sessionId: string;
  title: string;
...
export type TerminalKind =
  | { kind: "done"; content: string; message_id?: string | null }
  | { kind: "error"; message: string }
  | { kind: "cancelled"; partial_content: string; partial_reasoning: string };
/**
...
export type ThreadEvent =
  | { event: "content_chunk"; generation: number; session_key: string; data: string }
  | {
      event: "tool_start";
      generation: number;
      session_key: string;
  ...
  | { event: "pipeline_started"; generation: number; session_key: string }
  | {
  ...
  | { event: "heartbeat"; generation: number; session_key: string; server_time: number }
  | {
      event: "terminal";
      generation: number;
      session_key: string;
